...
const Signup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!email || !password || !confirmPassword || !role || !user_name) {
      ...
      <div className="signup-container">
        ...
        <div className="signup-content">
          ...
          <div className="images-captions">
            <h3 className=" welcome-to">  <p> Welcome To InterLinker</p></h3>
          </div>
          <div className='images-sub'>
            <h6 className=" subs-heading"> <p> Navigating the Student Journey, Connecting Opportunities, and Amplifying Student Engagement </p></h6>
          </div>
